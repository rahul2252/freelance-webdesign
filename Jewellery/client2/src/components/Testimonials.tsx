...
export default function Testimonials() {
  ...
  return (
    <section className="py-24 md:py-32 px-6 lg:px-10 bg-obsidian">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <div className="relative h-56 md:h-44 flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              <p className="font-serif text-xl md:text-2xl text-ivory/90 leading-relaxed">
          ...
          {testimonials.map((t, i) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 ${
                i === index ? "w-8 bg-gold" : "w-1.5 bg-ivory/30 hover:bg-ivory/60"
              }`}
            />
          ))}
        </div>
