...
export default function BrandStory() {
  ...
  return (
    <section id="about" className="py-24 md:py-32 px-6 lg:px-10 bg-onyx">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
        ...
        <Reveal delay={150}>
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-pearl mb-6">
            {heading}
          </h2>
          <p className="text-pearl/70 leading-relaxed text-base md:text-lg font-light">
            {body}
          </p>
        </Reveal>
      </div>
