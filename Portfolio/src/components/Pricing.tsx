...
export default function Pricing() {
  const { heading, subheading, price, priceNote, features, domainNote, ctaLabel } =
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Reveal>
          <div className="brutal-border border-paper brutal-shadow bg-panel p-8 md:p-12">
            ...
            <p className="mt-8 text-paper/55 text-xs md:text-sm font-light leading-relaxed border-t-2 border-paper/20 pt-6">
              {domainNote}
            </p>
