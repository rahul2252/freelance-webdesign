...
export default function Testimonials() {
  ...
  return (
    <section className="py-24 md:py-32 px-6 lg:px-10 bg-void">
      <div className="mx-auto max-w-3xl text-center">
        <Reveal className="mb-14 md:mb-16">
          <p className="text-xs uppercase tracking-[0.3em] text-cobalt mb-3">
            Testimonials
          </p>
          <h2 className="font-serif text-4xl md:text-5xl text-frost">
        ...
        <div className="relative h-56 md:h-44 flex items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              <p className="font-serif text-xl md:text-2xl text-frost/90 leading-relaxed">
          ...
          {testimonials.map((t, i) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 ${
                i === index ? "w-8 bg-cobalt" : "w-1.5 bg-frost/30 hover:bg-frost/60"
              }`}
            />
          ))}
        </div>
