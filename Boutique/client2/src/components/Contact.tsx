...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 md:py-32 px-6 lg:px-10 bg-sand">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16">
        <Reveal>
          ...
          <address className="not-italic text-ink/70 leading-relaxed mb-8">
          ...
          <div className="mb-8">
            <p className="text-xs uppercase tracking-[0.2em] text-moss-soft mb-2">
              Hours
            </p>
          ...
          <div className="flex flex-col gap-3 text-ink/70">
            <a href={phoneHref} className="hover:text-moss transition-colors w-fit">
              {phone}
            </a>
            <a href={emailHref} className="hover:text-moss transition-colors w-fit">
              {email}
            </a>
            <a
              ...
              className="inline-flex items-center gap-2 mt-3 px-6 py-3 bg-moss text-cream text-xs uppercase tracking-[0.2em] w-fit hover:bg-moss-soft transition-colors"
            >
              Chat on WhatsApp
            </a>
          </div>
